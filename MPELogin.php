...
<body>
<center>
<h1> Medical Access for E</h1>

<?php
    $query = "select * from patient where area_code= 'E'";
...
<?php
	 if(isset($_POST['save']))
	 {
	  ...
	  $query = "update patient set total_cases=$_POST[tc], currently_sick=$_POST[cs], discharged=$_POST[di], dead=$_POST[de] where area_code='E' ";
	  $query_run= mysqli_query($connection, $query);
	 }
